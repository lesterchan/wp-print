 ...
 *
 * The two legacy rows go too. Deleting a plugin whose site never served
 * another request after the upgrade would otherwise leave them behind, because
 * the migration that folds them in runs on init and would never have fired.
 *
