...
if ( $comments ) : ?>
	...
	<div id="comments_box">
		...
		<?php foreach ( $comments as $comment ) : ?>
			<p class="CommentDate">
				<strong>#<?php echo number_format_i18n( $comment_count ); ?> <?php comment_type( __( 'Comment', 'wp-print' ), __( 'Trackback', 'wp-print' ), __( 'Pingback', 'wp-print' ) ); ?></strong> <?php _e( 'By', 'wp-print' ); ?> <u><?php comment_author(); ?></u> <?php _e( 'On', 'wp-print' ); ?> <?php comment_date( sprintf( __( '%1$s @ %2$s', 'wp-print' ), get_option( 'date_format' ), get_option( 'time_format' ) ) ); ?>
			</p>
